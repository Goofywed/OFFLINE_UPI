...
//
//        // For demonstration purposes, you can print the JSON string
//        System.out.println("JSON String: " + json);
//
//        // Inform the user that answers have been converted to JSON
//        Toast.makeText(this, "Answers converted to JSON successfully!", Toast.LENGTH_SHORT).show();
//    }
//}
...
//            finish(); // Finish the activity after submitting answers
            startActivity(new Intent(SecurityQuestionsActivity.this, EnterPinActivity.class));
        }
    }
